...
export default function HomeV2() {
      ...
      const startAutoScroll = () => {
        ...
        scrollInterval = setInterval(() => {
          if (!isUserInteracting && slider) {
            ...
            // Scroll to next item
            const itemWidth = slider.querySelector('.hv2-slider-item')?.offsetWidth || 0;
  ...
  return (
    <div id="hv2-hero" className="hv2-page">
      <Helmet>
        <title>[MOCK] Home page redesign - BotWerx</title>
        <meta name="robots" content="noindex, nofollow" />
        <meta name="description" content="Unpublished mock home page. Not for public use." />
      </Helmet>
      {/* Hero Section - Redesigned with left/right layout */}
      <section className="hv2-hero">
        <div className="hv2-container">
          <h1 className="hv2-hero-title">{t('hero.title')}</h1>

          {/* Two-column layout: Benefits on left, Form on right */}
          <div className="hv2-hero-content">
            {/* Left column - Benefits */}
            <div className="hv2-hero-benefits">
              {heroBenefits.map((benefit, index) => (
                <div key={index} className="hv2-hero-benefit-item">
                  <h3 className="hv2-hero-benefit-title">{benefit.title}</h3>
                  <div className="hv2-hero-benefit-row">
                    <i className={`fas ${benefit.icon} hv2-hero-benefit-icon`}></i>
                    <p className="hv2-hero-benefit-description" dangerouslySetInnerHTML={{ __html: benefit.description }}></p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="hv2-hero-form-container">
              {/* Button commented out - form always visible
              <button
                type="button"
                className="hv2-btn hv2-btn-green"
      ...
      {/* Slider Section */}
      <section id="hv2-solutions" className="hv2-slider-section">
        <h2 className="hv2-section-title">{t('slider.title')}</h2>
        <div className="hv2-container">
          <div ref={sliderRef} className="hv2-slider-container">
            {[
              ...
              <div key={index} className="hv2-slider-item">
                <img src={item.img} alt={item.text} className="hv2-slider-image" />
                <p className="hv2-slider-text">{item.text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="hv2-services" className="hv2-cards-section">
        <h2 className="hv2-section-title inverted">{t('services.title')}</h2>
        <div className="hv2-container">
          <div className="hv2-cards-grid">
            {serviceItems.map((service, index) => (
              <div key={index} className="hv2-card">
                <div className="hv2-card-body">
                  <div className="hv2-black-bar"></div>
                  <div className="hv2-card-upper">
                    <div className="hv2-card-icon">
                      <i className={`fa-solid ${service.icon}`}></i>
                    </div>
                    <h3 className="hv2-card-title">{service.title}</h3>
                  </div>
                  <p className="hv2-card-text" dangerouslySetInnerHTML={{ __html: service.description }}></p>
                </div>
              </div>
            ))}
          </div>
          <div className="hv2-services-cta">
            <a href="#hv2-contact" className="hv2-btn" onClick={(e) => { e.preventDefault(); scrollToSection("hv2-contact"); }}>
      ...
      {/* FAQ Section */}
      <section id="hv2-faq" className="hv2-faq-section">
        <h2 className="hv2-section-title">{t('faq.title')}</h2>
        <div className="hv2-container">
          <div className="hv2-faq-list">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className={`hv2-faq-item ${activeFaqIndex === index ? "active" : ""}`}
              >
                <div className="hv2-faq-question" onClick={() => toggleFaq(index)}>
                  <span>{faq.question}</span>
                  <span className="hv2-faq-icon">+</span>
                </div>
                <div className="hv2-faq-answer">
      ...
      {/* Contact Section */}
      <section id="hv2-contact" className="hv2-contact-section">
        <div className="hv2-container">
          <form onSubmit={handleContactSubmit} className="hv2-form" id="hv2-contact-form">
            <h2>{t('contact.title')}</h2>

            <div className="hv2-form-row">
              <div className="hv2-form-group">
                <label htmlFor="name" className="hv2-form-label">
                  {t('contact.form.name')}:
                </label>
                <input
                  type="text"
                  ...
                  className="hv2-form-input"
                />
              </div>

              <div className="hv2-form-group">
                <label htmlFor="email" className="hv2-form-label">
            ...
            <div className="hv2-form-row">
              <div className="hv2-form-group">
                <label htmlFor="phone" className="hv2-form-label">
              ...
              <div className="hv2-form-group">
                <label htmlFor="contact-company" className="hv2-form-label">
            ...
            <div className="hv2-form-row">
              <div className="hv2-form-group">
                <label htmlFor="website" className="hv2-form-label">
            ...
            <div className="hv2-form-group">
              <label htmlFor="comments" className="hv2-form-label">
              ...
              <textarea
                ...
                onChange={handleFormChange}
                className="hv2-form-input hv2-form-textarea"
              />
            </div>

            {formError && <p className="hv2-form-error">{formError}</p>}
            {formSuccess && <p className="hv2-form-success">✅ {t('contact.success')}</p>}
