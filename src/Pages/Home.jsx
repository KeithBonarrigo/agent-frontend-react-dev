...
import "../styles/Home.css"; // This should be the Home-exact.css file
...
export default function Home() {
  ...
  // ✅ Mobile detection for responsive inline layout
  ...
  // ✅ FULL payload shape for createAndCheckUser(pool, userData)
  // ✅ Added confirm_password + confirm_contact_email (frontend-only)
  ...
  // ✅ Collapsible state + refs for smooth transition
  const [isAgentFormOpen, setIsAgentFormOpen] = useState(false);
  const agentFormWrapperRef = useRef(null);
  const agentFormInnerRef = useRef(null);

  // Animate open/close by setting maxHeight to content height
  useEffect(() => {
  ...
  // If the window resizes while open, recompute height so it doesn't clip
  useEffect(() => {
    const wrapper = agentFormWrapperRef.current;
    const inner = agentFormInnerRef.current;
    if (!wrapper || !inner) return;
  ...
  // FAQ data matching aibridge.global
  const faqs = [
    {
  ...
  const handleContactSubmit = async (e) => {
    ...
    try {
      // ✅ USE VITE_API_URL FOR PORTAL API
  ...
  // ✅ Handles text + checkbox inputs cleanly
  ...
  const normalizePayload = (raw) => {
    ...
    return {
      ...
      // NOTE: confirm_contact_email is frontend-only (not sent)
  ...
  // ✅ Used for asterisk styling without requiring CSS changes
  const requiredAsteriskStyle = { color: "#d11", marginLeft: "0px" };

  // ✅ Shared inline responsive row helper (no CSS changes)
  const rowWrapStyle = {
    display: "flex",
  ...
  return (
    <div className="home-page">
      ...
      <section className="home-hero">
        <div className="home-container">
          ...
          <button
            ...
            onClick={() => {
              setIsAgentFormOpen(true);
              setTimeout(() => scrollToSection("agent-form"), 50);
            }}
            style={{ marginTop: "2em" }}
          >
      ...
      {/* ✅ Agent Form Section */}
      <section id="agent-form" className="home-contact-section">
        <div className="home-container">
          <form onSubmit={handleAgentFormSubmit} className="home-form">
            <h2 style={{ marginBottom: "6px" }}>Build Your Agent in 30 Seconds</h2>
            ...
            >
             ...
             <br />
              ...
              <p style={{ marginTop: ".5em", marginBottom: ".5em" }}>
                <i>Already have an account?</i> <a href="/login">Log in</a> and manage your agent.
              </p>
            </p>
            ...
            <div style={{ display: "flex", justifyContent: "center", marginBottom: "12px" }}>
              <button
                ...
                aria-expanded={isAgentFormOpen}
                aria-controls="agent-collapsible"
              >
                {isAgentFormOpen ? "Close" : "Let's Get Started!"}
              </button>
            </div>

            <div
              id="agent-collapsible"
              className={`agent-collapsible ${isAgentFormOpen ? "open" : ""}`}
            ...
            >
              <div ref={agentFormInnerRef}>
                ...
                {/* ✅ Email + Confirm Email side-by-side on desktop; stacked on mobile */}
                <div style={rowWrapStyle}>
                  <div className="home-form-group" style={{ flex: 1 }}>
