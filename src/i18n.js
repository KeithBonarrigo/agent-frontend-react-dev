...
import esHomev2 from './locales/es/homev2.json';
...
i18n
  ...
  .init({
    ...
    fallbackLng: 'en',
    defaultNS: 'common',
    ns: ['common', 'dashboard', 'signup', 'models', 'integrations', 'home', 'homev2', 'configurations', 'styling', 'conversations', 'metrics', 'leads', 'legal', 'login', 'agent', 'audienceinsights', 'incomereport'],
